...
const Primary = {
  args: {
    label: "Legal requirement statement 1",
    requirements: [{
...
const Secondary = {
  args: {
    label: "Legal requirement statement 2",
    requirements: [{
      text: "Must be at least 8 characters",
      validator: val => val.length >= 8
    }, {
...
//# sourceMappingURL=stories-Requirements-stories.b0f52f9b4e4b8e8d890d.hot-update.js.map